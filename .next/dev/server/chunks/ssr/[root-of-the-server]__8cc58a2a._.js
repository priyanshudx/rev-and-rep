...
;
const metadata = {
    title: 'Rev & Rep - Performance Gym & Car Wash',
    description: 'Experience the ultimate fusion of automotive passion and modern fitness. Rev Your Engine. Rep Your Limits.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
